...
const CUSBMSDGadget::TUSBMSTGadgetConfigurationDescriptor
	CUSBMSDGadget::s_ConfigurationDescriptor =
{
	{
...
void CUSBMSDGadget::HandleSCSICommand(){
  switch(m_CBW.CBWCB[0]){
    ...
    case 0x3: // Request sense CMD
	 {
	    ...
	    m_pEP[EPIn]->BeginTransfer(CUSBMSDGadgetEndpoint::TransferDataIn,m_InBuffer,SIZE_RSR);
	...
	case 0x12: // Inquiry
	 {
	    ...
	    m_pEP[EPIn]->BeginTransfer(CUSBMSDGadgetEndpoint::TransferDataIn,m_InBuffer,SIZE_INQR);
	...
	case 0x1A: // Mode sense (6)
	 {
		...
		m_nnumber_blocks=0; //nothing more after this send
	    m_pEP[EPIn]->BeginTransfer(CUSBMSDGadgetEndpoint::TransferDataIn,m_InBuffer,SIZE_MODEREP);
	    m_nState=TMSDState::DataIn;	
		m_CSW.bmCSWStatus=MSD_CSW_STATUS_OK;
		m_ReqSenseReply.bSenseKey = 0; 
        m_ReqSenseReply.bAddlSenseCode = 0;		
	...
	case 0x23: // format capacity
	 {
		//TODO capacity from CSD
       	memcpy(&m_InBuffer,&m_FormatCapReply,SIZE_FORMATR);
		m_nnumber_blocks=0; //nothing more after this send
	    m_pEP[EPIn]->BeginTransfer(CUSBMSDGadgetEndpoint::TransferDataIn,m_InBuffer,SIZE_FORMATR);
	    m_nState=TMSDState::DataIn;	
		m_CSW.bmCSWStatus=MSD_CSW_STATUS_OK;
		m_ReqSenseReply.bSenseKey = 0; 
        m_ReqSenseReply.bAddlSenseCode = 0;		
    ...
    case 0x25: // Read capacity (10))
	 {
		...
		m_nnumber_blocks=0; //nothing more after this send
	    m_pEP[EPIn]->BeginTransfer(CUSBMSDGadgetEndpoint::TransferDataIn,m_InBuffer,SIZE_READCAPREP);
	    m_nState=TMSDState::DataIn;	
		m_CSW.bmCSWStatus=MSD_CSW_STATUS_OK;
		m_ReqSenseReply.bSenseKey = 0; 
        m_ReqSenseReply.bAddlSenseCode = 0;		
